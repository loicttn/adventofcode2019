...
def step2(path1, path2):
    list1, list2 = [], []
    list1 = draw_list(path1, list1)
    list2 = draw_list(path2, list2)
    set1, set2 = set(), set()
    set1 = draw_set(path1, set1)
    set2 = draw_set(path2, set2)
    maxi = list2 if len(list2) > len(list1) else list1
    mini = list1 if len(list2) > len(list1) else list2
    setmaxi = set2 if len(set2) > len(set1) else set1
    setmini = set1 if len(set2) > len(set1) else set2
    inter = setmaxi.intersection(setmini)
